            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-blue-200 dark:border-blue-900">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-[10px] font-bold text-blue-600 shrink-0">4</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">
                      <p className="mb-1 font-bold">Configure GitHub Secrets:</p>
                      <p className="mb-1">Add <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">CLOUDFLARE_API_TOKEN</code> to your GitHub repo secrets.</p>
                      <p className="text-[10px] opacity-70">Template: "Edit Cloudflare Pages" with Account Settings:Read, Workers:Edit, Pages:Edit.</p>
                    </div>
                  </div>
                </div>
              </div>
